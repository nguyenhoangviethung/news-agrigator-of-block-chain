...
import com.crawl.dataFromWebsite.*;
...
public class TotalData {
    ...
    public void setDataList() {
        ...
        TotalData.setCOUNT_SOURCE("src\\main\\java\\com\\crawl\\dataFromWebsite");
    ...
    public void crawl() {
        try{
            ...
            List<Data> data = dataList.getTotalData();
